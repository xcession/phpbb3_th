...
$lang = array_merge($lang, array(
	...
	'EDIT_DETAILS_TEMPLATE_EXPLAIN'		=> 'คุณสามารถแก้ไขรายละเอียด Template เช่น ชื่อ คุณยังสามารถสลับที่เก็บระหว่าง stylesheet จากระบบไฟล์ไปเป็นฐานข้อมูลหรือในทางกลับกันก็ได้. ตัวเลือกนี้ขึ้นกับการปรับแต่ง PHP และขึ้นกับว่า Template ของคุณสามารถเขียนลงบนเวบเซิร์ฟเวอร์ได้หรือไม่',
	'EDIT_DETAILS_THEME'				=> 'แก้ไขรายละเอียด Theme ',
	'EDIT_DETAILS_THEME_EXPLAIN'		=> 'คุณสามารถแก้ไขรายละเอียด Theme เช่น ชื่อ คุณยังสามารถสลับที่เก็บระหว่างstylesheet จากระบบไฟล์ไปเป็นฐานข้อมูลหรือในทางกลับกันก็ได้. ตัวเลือกนี้ขึ้นกับการปรับแต่ง PHP และขึ้นกับว่า Template ของคุณสามารถเขียนลงบนเวบเซิร์ฟเวอร์ได้หรือไม่',
